...
global.ytch = "The developer King Saqr";
...
async function handleMessages(sock, messageUpdate, printLog) {
    try {
        ...
        if (isGroup && isAdminCommand) {
            ...
            if (!isBotAdmin) {
                await sock.sendMessage(chatId, { text: 'يرجى جعل الروبوت مسؤولاً لاستخدام أوامر المسؤول.', ...channelInfo }, { quoted: message });
                return;
            }
        ...
        switch (true) {
            case userMessage === '.simage': {
                ...
                if (quotedMessage?.stickerMessage) {
                    ...
                    await sock.sendMessage(chatId, { text: 'يرجى الرد على الملصق باستخدام الأمر .simage لتحويله.', ...channelInfo }, { quoted: message });
                }
